...
import { DocumentData, Timestamp, collection, doc, onSnapshot, setDoc, updateDoc } from "firebase/firestore";
import { db } from "../../config/firebase";
import { actions } from "../../store/eventSlice";
...
export const useFireStore = <T extends DocumentData>(path: string) => {
   ...
   const createDocument = async (data: T) =>{
    ...
    return {loadCollection,loadDocument,updateDocument,createDocument}
